...
void loop() {
  ...
  if (keyboard.available()) {
    ...
    if (sc!=0) {
      ...
      switch (scState){
        case stPRESS:
        Serial.print("stPRESS:"); Serial.println(sc);
        if (sc==0xF0) scState = stRELEASE;
          else if (sc==0xE0) scState = stPRESS_E0;
          else if (sc==0xE1) scState = stPRESS_E1_1;
          else if ((sc==0x59) | (sc==0x12)) {shiftPressed = true; Serial.println("SHIFT");}
          else {
             if (shiftPressed){
            ...
            Serial.print("SHIFTP:"); Serial.print(shiftPressed);
            Serial.print("shift:"); Serial.print(shift);
            Serial.print(" v:"); Serial.print(v);
            Serial.print(" row:"); Serial.print(row);
            Serial.print(" column:"); Serial.print(column);
            Serial.println();
          }
          break;
        case stRELEASE:
          Serial.print("stRELEASE:"); Serial.println(sc);
          if ((sc==0x59) | (sc==0x12)) { shiftPressed = false; Serial.println("SHIFT RELEASE");}
          else {
             if (shiftPressed){
              v = findShiftedCode(sc);
              //if (v==(NULL  + 40))
          ...
          break;
        case stPRESS_E0:
          Serial.print("stPRESS_E0:"); Serial.println(sc);
          if (sc==0xF0) {scState = stRELEASE_E0; Serial.println("GO TO RELEASE E0");}
          else {
            v = findE0Code(sc);
            shift = (v >> 6) & 1;
            row = (v & 0b00111111) / 5;
          ...
          break;
        case stRELEASE_E0:
          Serial.print("stRELEASE_E0:"); Serial.println(sc);
          if ((sc==0x59) | (sc==0x12)) { shiftPressed = false; Serial.println("SHIFT RELEASE");}
          else {
            v = findE0Code(sc);
            shift = (v >> 6) & 1;
          ...
          break;
         case stPRESS_E1_1:
          Serial.print("stPRESS_E1_1:"); Serial.println(sc);
          scState = stPRESS_E1_2;
          break;
         case stPRESS_E1_2:
          Serial.print("stPRESS_E1_2:"); Serial.println(sc);
          scState = stPRESS;
          break;
     }
     Serial.print("ShiftP:"); Serial.print(shiftPressed);
     Serial.print(" rows=("); 
     Serial.print(rows[0]);Serial.print(", ");Serial.print(rows[1]);Serial.print(", ");Serial.print(rows[2]); Serial.print(", ");Serial.print(rows[3]);Serial.print(", ");
     Serial.print(rows[4]);Serial.print(", ");Serial.print(rows[5]);Serial.print(", ");Serial.print(rows[6]);Serial.print(", ");Serial.print(rows[7]);Serial.println(")");
    }
  }
